...
4. **Save configuration:** The user sets Cursor model/reasoning defaults, editable PRD/spec/execution agent descriptions, PRD/spec paths, and optional supporting documents.
...
8. **Land in chat:** `/chat` remains available, but chat execution is outside the current Cursor SDK refactor scope.
