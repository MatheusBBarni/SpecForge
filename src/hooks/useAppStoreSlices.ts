...
export function useProjectStoreSlice() {
  return useProjectStore(
    useShallow((state) => ({
      ...
      hasPrdPreview: state.hasPrdPreview,
      hasSpecPreview: state.hasSpecPreview,
      ...
      setProviderAuthMode: state.setProviderAuthMode,
      ...
      setPrdPreviewState: state.setPrdPreviewState,
      setSpecPreviewState: state.setSpecPreviewState,
