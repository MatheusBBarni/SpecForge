...
export function useAppScreenProps({
  ...
  const mainWorkspaceProps = useMemo(
    () => ({
      ...
      hasPrdPreview: projectState.hasPrdPreview,
      hasSpecPreview: projectState.hasSpecPreview,
      ...
      onDiscardPrdPreview: uiHandlers.handleDiscardPrdPreviewClick,
      onSaveSpecPreview: uiHandlers.handleSaveSpecPreviewClick,
      onDiscardSpecPreview: uiHandlers.handleDiscardSpecPreviewClick,
  ...
  const settingsScreenProps = useMemo<ComponentProps<typeof SettingsScreen>>(
    () => ({
      ...
      onModelChange: projectSettingsHandlers.handleProjectModelChange,
      onProviderAuthModeChange: projectSettingsHandlers.handleProviderAuthModeChange,
